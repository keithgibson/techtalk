...
**<table>**
  <tr>
    <th></th>
    <th style="font-size: 1.6em">🧠</th>
    <th class="fragment" data-fragment-index="14" style="font-size: 1.6em">🤖</th>
  </tr>
  <tr>
    <td class="fragment" data-fragment-index="1" style="font-size: 0.8em; font-weight: bold">input:</td>
...
**So that's a neural network.**<!-- .element: class="fragment semi-fade-out" data-fragment-index="1" -->

**What's a Transformer?** <!-- .element: class="fragment fade-in-then-semi-out" data-fragment-index="1" -->
...
The difference between transformers and other text-centric neural networks is in how they process information in the intermediate layers.

Specifically, in the implementation of something called the

# down

**"_multi-head attention mechanism_"**

which we'll explore in more detail in a few slides.
